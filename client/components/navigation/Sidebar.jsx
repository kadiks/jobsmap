...
const Sidebar = ({ cities, filterType, keywords, onChangeFilterType, onClickCity, onClickKeyword }) => {
    ...
    <div className="bg-indigo-600 h-screen">
      ...
      <div className="pt-4 flex flex-col space-x-px">
        <div className="flex-1">
          ...
          {filterType === "technologies" && <KeywordList keywords={keywords} onClick={onClickKeyword} />}
        </div>
        <Link href="/about">
